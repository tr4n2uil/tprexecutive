	...
	**/
	public function input(){
		return array(
			...
			'optional' => array('portalid' => COMPANY_PORTAL_ID, 'level' => 2, 'pname' => '', 'phone' => '', 'site' => '', 'country' => 'India', 'page' => ''),
	...
	**/
	public function run($memory){
		...
		array(
			...
			'args' => array('pnid', 'owner', 'username', 'name', 'email', 'phone', 'site', 'country', 'page', 'folder', 'home'),
			'conn' => 'exconn',
			'relation' => '`companies`',
			'sqlcnd' => "(`comid`,`owner`, `username`, `name`, `email`, `phone`, `site`, `country`, `page`, `resume`, `home`) values (\${pnid}, \${owner}, '\${username}', '\${name}', '\${email}', '\${phone}', '\${site}', '\${country}', '\${page}', \${resume}, \${home})",
			'escparam' => array('username', 'name', 'email', 'phone', 'site', 'country', 'page'),
