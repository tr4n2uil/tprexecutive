	...
	**/
	public function run($memory){
		...
		elseif($memory['archive']){
			...
			$prj = "concat(s.`rollno`, '_', s.`name`, '_Resume.pdf') as `asname`, d.`path` as `filepath`, f.`filename`, s.`resume` as `fresume`";
